...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.openup_suggestions'
        db.add_column('projects_project', 'openup_suggestions', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.openup_suggestions'
        db.delete_column('projects_project', 'openup_suggestions')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'openup_suggestions': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
